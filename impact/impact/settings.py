...
BREVO_INVITATION_CONSEILLER_RSE_TEMPLATE = int(
    os.getenv("BREVO_INVITATION_CONSEILLER_RSE_TEMPLATE", 185)
)
BREVO_ARRIVEE_NOUVEAU_MEMBRE_TEMPLATE = 196

# Users
AUTH_USER_MODEL = "users.User"
LOGIN_URL = "/connexion"
LOGIN_REDIRECT_URL = "/post-login-dispatch"
LOGOUT_REDIRECT_URL = "/"
...
# Compte utilisateur test pour les utilisateurs qui n'ont même pas d'accès proconnect comme les étudiants par exemple.
USER_TEST_EMAIL = os.getenv("USER_TEST_EMAIL")
