...
OIDC_OP_LOGOUT_ENDPOINT = f"https:/{OIDC_PC_ISSUER}/logout"
...
OIDC_USERINFO_FULLNAME_FIELDS = [
    "given_name",
    "usual_name",
]  # Fields used to compute user's full name, defaults to `[]`
OIDC_USERINFO_ESSENTIAL_CLAIMS = [
    ...
    "siret",
    "email",
]  # Claims required for user identification, defaults to `[]`
