...
def selectionne_diapos_jamais_utilisees(indicateurs):
    ...
    return {
        ...
        68,  # C5 Caractéristiques supplémentaires (générales)...
        70,  # C6 Informations complémentaires sur les effectifs...
        73,  # C7 Incidents graves en matière de droits de l’homme
        75,  # C7 Incidents graves en matière de droits de l’homme (2)
        78,  # B11 Condamnations et amendes en matière de lutte...
        80,  # C8 Recettes de certains secteurs et exclusion...
    }
