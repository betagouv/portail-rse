...
@login_required
@entreprise_requise
def etape_vsme(request, entreprise, etape):
    match etape:
        case "introduction":
...
def exigence_de_publication_vsme(request, rapport_vsme, exigence_de_publication_code):
    ...
    indicateurs_applicables = rapport_vsme.indicateurs_applicables_par_exigence(
        exigence_de_publication
    )
...
def export_vsme(request, rapport_vsme):
    ...
    choix_module = rapport_vsme.choix_module or rapport_vsme.CHOIX_MODULE_PAR_DEFAUT
    match choix_module:
        case rapport_vsme.CHOIX_MODULE_COMPLET:
            texte = "Module complet"
        case rapport_vsme.CHOIX_MODULE_BASE:
